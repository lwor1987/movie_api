...
const allowedOrigins = ['http://localhost:8080', 'https://intense-ridge-76926.herokuapp.com/', 'http://localhost:1234', 'https://kaleidoscopic-stroopwafel-8d953d.netlify.app' ];
app.use(cors({
